...
enum CurrencyCatalog {
    ...
    private static let modern: [Currency] = [
        .init(code: "AED", flag: "🇦🇪", country: "Émirats arabes unis", increment: 0.25,
        ...
        .init(code: "DZD", flag: "🇩🇿", country: "Algérie", digits: 0,
              denominations: [2000, 1000, 500, 200, 100, 50, 20, 10, 5, 2, 1]),
        .init(code: "EGP", flag: "🇪🇬", country: "Égypte", increment: 0.25,
              denominations: [200, 100, 50, 20, 10, 5, 1, 0.5, 0.25]),
        ...
        .init(code: "MAD", flag: "🇲🇦", country: "Maroc", increment: 0.1,
        ...
        .init(code: "QAR", flag: "🇶🇦", country: "Qatar"),
        .init(code: "RON", flag: "🇷🇴", country: "Roumanie"),
        .init(code: "SAR", flag: "🇸🇦", country: "Arabie saoudite"),
        .init(code: "SEK", flag: "🇸🇪", country: "Suède", digits: 0),
        .init(code: "SGD", flag: "🇸🇬", country: "Singapour"),
        .init(code: "THB", flag: "🇹🇭", country: "Thaïlande"),
        .init(code: "TND", flag: "🇹🇳", country: "Tunisie", digits: 3, increment: 0.005,
              denominations: [50, 20, 10, 5, 2, 1, 0.5, 0.2, 0.1, 0.05, 0.02, 0.01, 0.005]),
        .init(code: "TRY", flag: "🇹🇷", country: "Turquie"),
        .init(code: "TWD", flag: "🇹🇼", country: "Taïwan", digits: 0,
              denominations: [2000, 1000, 500, 200, 100, 50, 20, 10, 5, 1]),
        ...
        .init(code: "XAF", flag: "🌍", country: "Afrique centrale (CFA)", digits: 0),
        .init(code: "XOF", flag: "🌍", country: "Afrique de l'Ouest (CFA)", digits: 0),
        .init(code: "XPF", flag: "🇵🇫", country: "Polynésie française", digits: 0,
              denominations: [10000, 5000, 1000, 500, 100, 50, 20, 10, 5, 2, 1]),
